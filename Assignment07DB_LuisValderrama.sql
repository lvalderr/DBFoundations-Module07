--*************************************************************************--
-- Title: Assignment07DB_LuisValderrama
-- Author: Luis Valderrama
-- Desc: This file demonstrates how to use Functions
-- Change Log: When,Who,What
-- 2021-05-21,Luis Valderrama,Created File
--**************************************************************************--

/*Objective
1. create Database and tables using Assignment07 script
2. add data, constraints and views following previous modules
3. answer questions 1 - 8
*/

Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_LuisValderrama')
	 Begin 
	  Alter Database [Assignment07DB_LuisValderrama] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_LuisValderrama;
	 End
	Create Database Assignment07DB_LuisValderrama;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_LuisValderrama;
...
SELECT ProductName
     , FORMAT (UnitPrice,'C', 'en-US') AS 'UnitPrice' --'C' is Currency
FROM Products
